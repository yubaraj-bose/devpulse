...
export default function UserProfilePage() {
  ...
  function SectionList({ title, subtitle, keyName }) {
  ...
  function SectionEditorModal({ open, onClose }) {
    if (!open) return null;
  ...
  return (
    <div className={THEME_BG}>
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-16">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8 space-y-8 min-w-0">
            <SectionList title="Open Source" subtitle="Contributions & Repos" keyName="openSource" />
            <SectionList title="Projects" subtitle="Building things" keyName="projects" />
            <SectionList title="Tutorials" subtitle="Sharing knowledge" keyName="tutorials" />
            <SectionList title="Articles" subtitle="Deep dives" keyName="articles" />
          </div>
      ...
      <SectionEditorModal open={!!editingSection} onClose={() => setEditingSection(null)} />
    </div>
  );
}